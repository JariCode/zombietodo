...
<body>
    ...
    <div class="container no-caret">
        ...
        <div class="auth-box">
            ...
            <form method="POST" action="app/actions.php" autocomplete="off" data-loading> <!-- Toiminto kulkee nyt piilokenttänä POST-bodyssa eikä URL-parametrina -->
        ...
        <div class="auth-box">
            ...
            <form method="POST" action="app/actions.php" data-loading> <!-- Toiminto kulkee nyt piilokenttänä POST-bodyssa eikä URL-parametrina -->
